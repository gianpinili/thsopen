  ...
  <>
   ...
   <div className="mt-[5rem] font-spacemono flex flex-col md:flex-row mx-[1rem] gap-12 mb-12 sm:mx-[2rem] md:gap-4 lg:mx-[3rem] lg:gap-8 2xl:mx-[5rem]">
    <div className="flex flex-col gap-12 md:gap-[5rem] items-start md:w-1/2 md:pl-[1rem] lg:pl-[3rem]">
     ...
     {/* <a href="https://docs.google.com/forms/d/e/1FAIpQLSdXnnFZA88NFBH-Fg546B_edYD9xTRObjKpZX3C82Igq5Ls4A/viewform?vc=0&c=0&w=1&flr=0" target="_blank" className="border px-6 py-2 rounded-md hover:bg-white hover:text-black duration-300">Registration: August 10, 2024</a> */}
