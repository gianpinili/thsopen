  ...
  <>
   <section className='flex flex-col-reverse md:flex-row my-10 mx-4 font-spacemono md:mx-10 lg:gap-4 xl:gap-8 2xl:gap-10 xl:mx-[3rem] 2xl:mx-[4rem]'>
    ...
    <div className='relative flex md:w-1/2 md:mb-[3rem] xl:mb-[4rem] 2xl:mb-[6rem]'>
     <img src={MitchAbout} alt="Mitch About" width={'400px'} className='rounded-md w-[80%] ml-3 md:object-cover' />
     <img src={MitchAbout2} alt="Mitch About 2" width={'400px'} className='rounded-md absolute w-[50%] right-5 bottom-[-4rem] ' />
     <img src={THSOpen} alt="THS Open Logo" className='absolute bottom-[-5rem] left-[4.5rem] -translate-x-1/2 -translate-y-1/2 w-[20%] sm:left-[6.5rem] sm:bottom-[-7rem] md:bottom-[-6rem] md:left-[5.5rem] md:w-[30%] lg:bottom-[-8rem] lg:left-[6.5rem] xl:bottom-[-9rem] xl:left-[7.5rem] 2xl:bottom-[-10.5rem] 2xl:left-[9rem]' />
    </div>
    {/* RIGHT SIDE TEXT */}
