 ...
 return (
  <div ref={ref} className={`mt-[2rem] 2xl:mt-[3.3rem] font-spacemono relative w-full max-h-screen overflow-hidden transition-opacity duration-[2.5s] ${isIntersecting ? 'opacity-100' : 'opacity-0'}`}>
   <video
    ...
    loop
    muted
    className="w-full mt-[-2rem] md:mt-[-2rem] lg:mt-[-2rem] xl:mt-[-2rem] 2xl:mt-[-2.25rem] h-[100vh] md:h-[100vh] lg:h-[100vh] xl:h-[100vh] object-cover opacity-70 disable-video-interaction"
   >
   ...
   <div className="absolute top-[35%] bg-none z-10 flex flex-col items-center justify-center gap-10 md:mx-[5rem] lg:mx-[10rem] xl:mx-[15rem] 2xl:mx-[20rem]">
    ...
    <Link to={'/contact'} className="border-white border py-2 px-4 rounded mt-4 hover:bg-slate-100 hover:text-black duration-200 md:py-4 md:px-8">Registration Coming Soon</Link>
