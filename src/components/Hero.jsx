...
function Hero() {
 return (
  <div className=" mt-[-2rem] font-spacemono relative w-full max-h-screen overflow-hidden">
   <video
    autoPlay
    loop
    muted
   ...
   <div className="absolute top-[40%] bg-none z-10 flex flex-col items-center justify-center gap-10 md:mx-[5rem] lg:mx-[10rem] xl:mx-[15rem] 2xl:mx-[20rem]">
    <h1 className="text-white leading-9 scale-y-200 tracking-normal text-[2rem] md:text-[3rem] xl:text-[3.1rem] bg-transparent uppercase font-poppins font-extrabold text-center font-sans">Register Your Team</h1>
