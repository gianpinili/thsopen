...
function Merch() {
 return (
  <>
   <div className="my-10 mx-[1.5rem] md:mx-[2rem] lg:mx-[3rem] font-spacemono 2xl:px-[8rem]">
    <h1 className="font-poppins font-semibold text-3xl md:text-5xl uppercase tracking-tighter">Shop the merch</h1>
