 ...
 return (
  <>
   <section id='events' className="font-spacemono relative px-4 pb-10 md:px-10 md:pb-20 lg:pb-[8rem] xl:pb-[10rem] lg:px-14 xl:px-[3rem] 2xl:px-[8rem] bg-[#1c1c1c]">
    <h1 className="font-poppins z-20 pt-16 pb-2 sm:pb-20 font-bold text-[5.2rem] md:text-[7rem] lg:text-[8rem] xl:text-[9rem] 2xl:text-[10rem] uppercase tracking-tighter relative text-center">EVENTS</h1>
    <div className='flex flex-col md:flex-row-reverse relative'>
     <div className='relative flex-1'>
      <img src={MitchBall} alt="Newlands Golf" className='bnw-filter rounded-md z-20 absolute h-auto w-[50%] bottom-[-20rem] -translate-x-1/2 translate-y-1/2 left-[27%] max-w-[500px] sm:top-[-3rem] sm:w-[45%] md:top-[3rem] lg:top-[1rem] lg:left-[32%] xl:top-[0rem] 2xl:top-[-5rem]' />
      <img src={MitchEvent} alt="THS Open" className='bnw-filter rounded-md absolute top-0 right-0 h-auto w-[70%] max-w-[300px] sm:top-[-4rem] sm:right-10 sm:max-w-[325px] md:top-[-8rem] lg:top-[-14rem] lg:max-w-[350px] xl:max-w-[400px] 2xl:top-[-16rem] 2xl:max-w-[400px]' />
     </div>
     <div className='flex flex-col gap-10 items-center justify-center mt-[30rem] sm:mt-[28rem] md:mt-0 md:flex-1'>
      <p className='text-center text-sm lg:text-md xl:text-[1rem] leading-7 2xl:text-xl 2xl:px-6 md:mt-[-3rem]'>Get ready to tee off for a great cause at the 1st Annual THS Open, proudly presented by The Hockey Shop! We&apos;re excited to invite you to join us at the stunning Newlands Golf and Country Club [Championship course] on September 16, 2024, for a day of fun, competition, and breathtaking scenery.</p>
