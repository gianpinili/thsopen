...
function Event() {
 ...
 return (
  <div ref={ref} className={`bg-[#1c1c1c] font-spacemono pt-[3rem] px-[1.5rem] flex flex-col md:px-[2rem] lg:px-[3rem] relative h-[80vh] md:h-full 2xl:px-[8rem] transition-opacity duration-[2s] ${isIntersecting ? 'opacity-100' : 'opacity-0'}`}>
   <div>
