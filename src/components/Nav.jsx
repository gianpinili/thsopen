...
function Nav() {
 ...
 return (
  <>
   <div className='font-spacemono flex justify-between items-center my-8 mx-[4rem] md:mb-14 z-30'>
    <div className='hidden md:flex gap-6'>
     <Link to={'/event'} className='hover:border-b border-white hover:scale-125 duration-200'>Event</Link>
     <Link to={'/merch'} className='hover:border-b border-white hover:scale-125 duration-200'>Merch</Link>
     <Link to={'/sponsorship'} className='hover:border-b border-white hover:scale-125 duration-200'>Sponsor</Link>
    </div>
    <Link className='flex justify-center'>
     <img className='w-[70%] md:max-w-[150px] lg:mr-[6rem]' src={Logo} alt="THS Open Logo" />
    </Link>
   ...
   {isModalOpen && (
    <div className='fixed inset-0 bg-black bg-opacity-90 flex justify-center items-center z-20'>
     <div className=' w-full h-full p-2 rounded shadow-lg'>
      ...
      <div className='flex flex-col gap-5 m-3 pt-14'>
